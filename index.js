...
bot.on('guildMemberAdd', member => {
  ...
  member.guild.channels.get('482867073773731864').setName(`⭐ Goal: ${member.guild.memberCount}/100`)

    let canal = member.guild.channels.find('id', '480358869638578177');
...
bot.login("NDgyODY5MzU5MzU0NzA3OTkz.DmLLOA.-jtayTITu9yYRmw5zdJ1_LIBbRU");
